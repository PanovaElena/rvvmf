...
forceinline void update_exponent_f32m1(const float& subnormalThreshold, const vfloat32m1_t& x,
    const vuint32m1_t& ei, vfloat32m1_t& res, size_t vl)
{
    ...
    vuint32m1_t pow2ei = __riscv_vsll_vx_u32m1(__riscv_vand_vx_u32m1(__riscv_vadd_vx_u32m1(ei, (uint32_t)253, vl),  // 253=126+127
        (uint32_t)0x000000ff, vl), (size_t)23, vl);
    // multiplication calls FE_UNDERFLOW if necessary
    vfloat32m1_t subnormalRes = __riscv_vfmul_vv_f32m1(res, __riscv_vreinterpret_v_u32m1_f32m1(pow2ei), vl);
    subnormalRes = __riscv_vfmul_vf_f32m1(subnormalRes, 0x1p-126f, vl);
...
{
    vfloat32m1_t sh, sl, sl1;
    fast_2_sum_fv_f32m1(ONE_F32, pm1h, sh, sl1, vl);
    sl = __riscv_vfadd_vv_f32m1(sl1, pm1l, vl);
    mul21_vv_f32m1(th, tl, sh, sl, res, vl);
    update_exponent_f32m1(subnormalThreshold, x, ei, res, vl);
}
...
{
    vfloat32m1_t rh, rl, rll;
    fast_2_sum_fv_f32m1(ONE_F32, pm1h, rh, rl, vl);
    fast_2_sum_vv_f32m1(rl, pm1l, rl, rll, vl);
    mul22_vv_f32m1(th, tl, rh, rl, rh, rl, vl);
    
    vuint32m1_t power = __riscv_vsll_vx_u32m1(ei, (size_t)23, vl);
    rh = __riscv_vreinterpret_v_u32m1_f32m1(__riscv_vadd_vv_u32m1(
        __riscv_vreinterpret_v_f32m1_u32m1(rh), power, vl));
    vbool32_t slZeroMask = __riscv_vmfeq_vf_f32m1_b32(rl, ZERO_F32, vl);
    rl = __riscv_vreinterpret_v_u32m1_f32m1(__riscv_vadd_vv_u32m1(
        __riscv_vreinterpret_v_f32m1_u32m1(rl), power, vl));
    rl = __riscv_vfmerge_vfm_f32m1(rl, ZERO_F32, slZeroMask, vl);
    
    vfloat32m1_t sh1, sl1;
    vbool32_t sortMask = __riscv_vmsgtu_vx_u32m1_b32(__riscv_vand_vx_u32m1(__riscv_vreinterpret_v_f32m1_u32m1(rh),
        (uint32_t)0x7f800000, vl), (uint32_t)0x3f800000, vl);
    vfloat32m1_t maxs = __riscv_vfmerge_vfm_f32m1(rh, EXPM1_UNDERFLOW_VALUE_F32, __riscv_vmnot_m_b32(sortMask, vl), vl);
    vfloat32m1_t mins = __riscv_vfmerge_vfm_f32m1(rh, EXPM1_UNDERFLOW_VALUE_F32, sortMask, vl);
    fast_2_sum_vv_f32m1(maxs, mins, sh1, sl1, vl);
    
    // exact sum of sh1, rl, (sl1+rll)
    vfloat32m1_t sh2, sl2, resl;
    sl2 = __riscv_vfadd_vv_f32m1(sl1, rll, vl);
    fast_2_sum_vv_f32m1(rl, sl2, sh2, sl2, vl);
    fast_2_sum_vv_f32m1(sh1, sh2, res, resl, vl);
    res = __riscv_vfadd_vv_f32m1(res, __riscv_vfadd_vv_f32m1(resl, sl2, vl), vl);
}
...
forceinline void update_exponent_f32m2(const float& subnormalThreshold, const vfloat32m2_t& x,
    const vuint32m2_t& ei, vfloat32m2_t& res, size_t vl)
{
    ...
    vuint32m2_t pow2ei = __riscv_vsll_vx_u32m2(__riscv_vand_vx_u32m2(__riscv_vadd_vx_u32m2(ei, (uint32_t)253, vl),  // 253=126+127
        (uint32_t)0x000000ff, vl), (size_t)23, vl);
    // multiplication calls FE_UNDERFLOW if necessary
    vfloat32m2_t subnormalRes = __riscv_vfmul_vv_f32m2(res, __riscv_vreinterpret_v_u32m2_f32m2(pow2ei), vl);
    subnormalRes = __riscv_vfmul_vf_f32m2(subnormalRes, 0x1p-126f, vl);
...
forceinline void reconstruct_exp_hl_hl_f32m2(const vfloat32m2_t& x, const vuint32m2_t& ei, const vfloat32m2_t& th, const vfloat32m2_t& tl,
    const vfloat32m2_t& pm1h, const vfloat32m2_t& pm1l, vfloat32m2_t& res, const float& subnormalThreshold, size_t vl)
{
    vfloat32m2_t sh, sl;
    fast_2_sum_fv_f32m2(ONE_F32, pm1h, sh, sl, vl);
    sl = __riscv_vfadd_vv_f32m2(sl, pm1l, vl);
    mul21_vv_f32m2(th, tl, sh, sl, res, vl);
    update_exponent_f32m2(subnormalThreshold, x, ei, res, vl);
}

forceinline void reconstruct_expm1_f32m2(const vfloat32m2_t& th, const vfloat32m2_t& tl, 
    const vfloat32m2_t& pm1h, const vfloat32m2_t& pm1l, const vuint32m2_t& ei, vfloat32m2_t& res, size_t vl)
{
    vfloat32m2_t rh, rl, rll;
    fast_2_sum_fv_f32m2(ONE_F32, pm1h, rh, rl, vl);
    fast_2_sum_vv_f32m2(rl, pm1l, rl, rll, vl);
    mul22_vv_f32m2(th, tl, rh, rl, rh, rl, vl);
    
    vuint32m2_t power = __riscv_vsll_vx_u32m2(ei, (size_t)23, vl);
    rh = __riscv_vreinterpret_v_u32m2_f32m2(__riscv_vadd_vv_u32m2(
        __riscv_vreinterpret_v_f32m2_u32m2(rh), power, vl));
    vbool16_t slZeroMask = __riscv_vmfeq_vf_f32m2_b16(rl, ZERO_F32, vl);
    rl = __riscv_vreinterpret_v_u32m2_f32m2(__riscv_vadd_vv_u32m2(
        __riscv_vreinterpret_v_f32m2_u32m2(rl), power, vl));
    rl = __riscv_vfmerge_vfm_f32m2(rl, ZERO_F32, slZeroMask, vl);
    
    vfloat32m2_t sh1, sl1;
    vbool16_t sortMask = __riscv_vmsgtu_vx_u32m2_b16(__riscv_vand_vx_u32m2(__riscv_vreinterpret_v_f32m2_u32m2(rh),
        (uint32_t)0x7f800000, vl), (uint32_t)0x3f800000, vl);
    vfloat32m2_t maxs = __riscv_vfmerge_vfm_f32m2(rh, EXPM1_UNDERFLOW_VALUE_F32, __riscv_vmnot_m_b16(sortMask, vl), vl);
    vfloat32m2_t mins = __riscv_vfmerge_vfm_f32m2(rh, EXPM1_UNDERFLOW_VALUE_F32, sortMask, vl);
    fast_2_sum_vv_f32m2(maxs, mins, sh1, sl1, vl);
    
    // exact sum of sh1, rl, (sl1+rll)
    vfloat32m2_t sh2, sl2, resl;
    sl2 = __riscv_vfadd_vv_f32m2(sl1, rll, vl);
    fast_2_sum_vv_f32m2(rl, sl2, sh2, sl2, vl);
    fast_2_sum_vv_f32m2(sh1, sh2, res, resl, vl);
    res = __riscv_vfadd_vv_f32m2(res, __riscv_vfadd_vv_f32m2(resl, sl2, vl), vl);
}
...
forceinline void update_exponent_f32m4(const float& subnormalThreshold, const vfloat32m4_t& x,
    const vuint32m4_t& ei, vfloat32m4_t& res, size_t vl)
{
    ...
    vuint32m4_t pow2ei = __riscv_vsll_vx_u32m4(__riscv_vand_vx_u32m4(__riscv_vadd_vx_u32m4(ei, (uint32_t)253, vl),  // 253=126+127
        (uint32_t)0x000000ff, vl), (size_t)23, vl);
    // multiplication calls FE_UNDERFLOW if necessary
    vfloat32m4_t subnormalRes = __riscv_vfmul_vv_f32m4(res, __riscv_vreinterpret_v_u32m4_f32m4(pow2ei), vl);
    subnormalRes = __riscv_vfmul_vf_f32m4(subnormalRes, 0x1p-126f, vl);
...
forceinline void reconstruct_exp_hl_hl_f32m4(const vfloat32m4_t& x, const vuint32m4_t& ei, const vfloat32m4_t& th, const vfloat32m4_t& tl,
    const vfloat32m4_t& pm1h, const vfloat32m4_t& pm1l, vfloat32m4_t& res, const float& subnormalThreshold, size_t vl)
{
    vfloat32m4_t sh, sl;
    fast_2_sum_fv_f32m4(ONE_F32, pm1h, sh, sl, vl);
    sl = __riscv_vfadd_vv_f32m4(sl, pm1l, vl);
    mul21_vv_f32m4(th, tl, sh, sl, res, vl);
    update_exponent_f32m4(subnormalThreshold, x, ei, res, vl);
}

forceinline void reconstruct_expm1_f32m4(const vfloat32m4_t& th, const vfloat32m4_t& tl, 
    const vfloat32m4_t& pm1h, const vfloat32m4_t& pm1l, const vuint32m4_t& ei, vfloat32m4_t& res, size_t vl)
{
    vfloat32m4_t rh, rl, rll;
    fast_2_sum_fv_f32m4(ONE_F32, pm1h, rh, rl, vl);
    fast_2_sum_vv_f32m4(rl, pm1l, rl, rll, vl);
    mul22_vv_f32m4(th, tl, rh, rl, rh, rl, vl);
    
    vuint32m4_t power = __riscv_vsll_vx_u32m4(ei, (size_t)23, vl);
    rh = __riscv_vreinterpret_v_u32m4_f32m4(__riscv_vadd_vv_u32m4(
        __riscv_vreinterpret_v_f32m4_u32m4(rh), power, vl));
    vbool8_t slZeroMask = __riscv_vmfeq_vf_f32m4_b8(rl, ZERO_F32, vl);
    rl = __riscv_vreinterpret_v_u32m4_f32m4(__riscv_vadd_vv_u32m4(
        __riscv_vreinterpret_v_f32m4_u32m4(rl), power, vl));
    rl = __riscv_vfmerge_vfm_f32m4(rl, ZERO_F32, slZeroMask, vl);
    
    vfloat32m4_t sh1, sl1;
    vbool8_t sortMask = __riscv_vmsgtu_vx_u32m4_b8(__riscv_vand_vx_u32m4(__riscv_vreinterpret_v_f32m4_u32m4(rh),
        (uint32_t)0x7f800000, vl), (uint32_t)0x3f800000, vl);
    vfloat32m4_t maxs = __riscv_vfmerge_vfm_f32m4(rh, EXPM1_UNDERFLOW_VALUE_F32, __riscv_vmnot_m_b8(sortMask, vl), vl);
    vfloat32m4_t mins = __riscv_vfmerge_vfm_f32m4(rh, EXPM1_UNDERFLOW_VALUE_F32, sortMask, vl);
    fast_2_sum_vv_f32m4(maxs, mins, sh1, sl1, vl);
    
    // exact sum of sh1, rl, (sl1+rll)
    vfloat32m4_t sh2, sl2, resl;
    sl2 = __riscv_vfadd_vv_f32m4(sl1, rll, vl);
    fast_2_sum_vv_f32m4(rl, sl2, sh2, sl2, vl);
    fast_2_sum_vv_f32m4(sh1, sh2, res, resl, vl);
    res = __riscv_vfadd_vv_f32m4(res, __riscv_vfadd_vv_f32m4(resl, sl2, vl), vl);
}

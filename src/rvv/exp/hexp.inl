...
const FLOAT16_T FACTOR_COEFF_F16 = 0x1p8f16;
const FLOAT16_T INV_FACTOR_COEFF_F16 = 0x1p-8f16;
const FLOAT16_T EXPM1_POL_COEFF_2_F16 = EXP_POL_COEFF_2_F16*FACTOR_COEFF_F16;
const FLOAT16_T EXPM1_POL_COEFF_3_F16 = EXP_POL_COEFF_3_F16*FACTOR_COEFF_F16;

const FLOAT16_T EXP2_POL_COEFF_1_H_F16 = 0x1.63p-1f16;
const FLOAT16_T EXP2_POL_COEFF_1_L_F16 = -0x1.bdp-13f16;
const FLOAT16_T EXP2_POL_COEFF_2_F16 = 0x1.ecp-3f16;
const FLOAT16_T EXP2_POL_COEFF_3_F16 = 0x1.c6cp-5f16;
...
forceinline void calculate_expm1_polynom_hl_f16m1(const vfloat16m1_t& yh, const vfloat16m1_t& yl, vfloat16m1_t& ph, vfloat16m1_t& pl, size_t vl)
{
    // ph + pl = polynom(yh+yl) * FACTOR_COEFF_F16
    vfloat16m1_t pl1;
    vfloat16m1_t sqryh = __riscv_vfmul_vv_f16m1(yh, yh, vl);
    vfloat16m1_t r = calc_polynom_deg_1_f16m1(yh, EXPM1_POL_COEFF_2_F16, EXPM1_POL_COEFF_3_F16, vl);
    r = __riscv_vfmul_vv_f16m1(r, yh, vl);
    mul12_vv_f16m1(yh, r, ph, pl1, vl);
    fast_2_sum_vv_f16m1(__riscv_vfmul_vf_f16m1(yh, FACTOR_COEFF_F16, vl), ph, ph, pl, vl);
    pl = __riscv_vfadd_vv_f16m1(pl, __riscv_vfadd_vv_f16m1(__riscv_vfmul_vf_f16m1(yl, FACTOR_COEFF_F16, vl), pl1, vl), vl);
}

forceinline void calculate_exp2_polynom_hl12_f16m1(const vfloat16m1_t& yh, vfloat16m1_t& ph, vfloat16m1_t& pl, size_t vl)
{
    vfloat16m1_t sqryh = __riscv_vfmul_vv_f16m1(yh, yh, vl);
    vfloat16m1_t r = calc_polynom_deg_1_f16m1(yh, EXP2_POL_COEFF_2_F16, EXP2_POL_COEFF_3_F16, vl);
    r = __riscv_vfmadd_vf_f16m1(yh, EXP2_POL_COEFF_1_L_F16, __riscv_vfmul_vv_f16m1(sqryh, r, vl), vl);
    fma12_ver2p1_vf_f16m1(yh, EXP2_POL_COEFF_1_H_F16, r, ph, pl, vl);
}

forceinline void update_exponent_f16m1(const FLOAT16_T& subnormalThreshold, const vfloat16m1_t& x,
    const vuint16m1_t& ei, vfloat16m1_t& res, size_t vl)
{
    ...
    vuint16m1_t pow2ei = __riscv_vsll_vx_u16m1(__riscv_vand_vx_u16m1(__riscv_vadd_vx_u16m1(ei, (uint16_t)29, vl),  // 29=14+15
        (uint16_t)0x001f, vl), (size_t)10, vl);
    // multiplication calls FE_UNDERFLOW if necessary
    vfloat16m1_t subnormalRes = __riscv_vfmul_vv_f16m1(res, __riscv_vreinterpret_v_u16m1_f16m1(pow2ei), vl);
    subnormalRes = __riscv_vfmul_vf_f16m1(subnormalRes, 0x1p-14f16, vl);
    ...
    const vfloat16m1_t& pm1h, const vfloat16m1_t& pm1l, vfloat16m1_t& res, const FLOAT16_T& subnormalThreshold, size_t vl)
{
    ...
    update_exponent_f16m1(subnormalThreshold, x, ei, res, vl);
}
...
{  
    // res = ((FACTOR_COEFF_F16 + pm1h + pm1l)*(th + tl) - FACTOR_COEFF_F16)/FACTOR_COEFF_F16
    vfloat16m1_t rh, rl, rll, sh, sl;
    fast_2_sum_fv_f16m1(FACTOR_COEFF_F16, pm1h, rh, rl, vl);
    fast_2_sum_vv_f16m1(rl, pm1l, rl, rll, vl);
    mul22_vv_f16m1(th, tl, rh, rl, rh, rl, vl);
    
    vuint16m1_t poweri = __riscv_vsll_vx_u16m1(ei, (size_t)10, vl);
    sh = __riscv_vfmul_vf_f16m1(rh, INV_FACTOR_COEFF_F16, vl);
    sh = __riscv_vreinterpret_v_u16m1_f16m1(__riscv_vadd_vv_u16m1(
        __riscv_vreinterpret_v_f16m1_u16m1(sh), poweri, vl));
    vfloat16m1_t power = __riscv_vreinterpret_v_u16m1_f16m1(__riscv_vsll_vx_u16m1(
        __riscv_vadd_vx_u16m1(ei, (uint16_t)15, vl), (size_t)10, vl));
    vbool16_t rlZeroMask = __riscv_vmfeq_vf_f16m1_b16(rl, ZERO_F16, vl);
    sl = __riscv_vreinterpret_v_u16m1_f16m1(__riscv_vadd_vv_u16m1(
        __riscv_vreinterpret_v_f16m1_u16m1(rl), poweri, vl));
    sl = __riscv_vfmerge_vfm_f16m1(sl, ZERO_F16, rlZeroMask, vl);
    vbool16_t infPowerMask = __riscv_vmseq_vx_u16m1_b16(__riscv_vand_vx_u16m1(
        __riscv_vreinterpret_v_f16m1_u16m1(power), (uint16_t)0x7c00, vl), (uint16_t)0x7c00, vl);
    sl = __riscv_vmerge_vvm_f16m1(__riscv_vfmul_vv_f16m1(power, rl, vl), sl, infPowerMask, vl);
    
    vfloat16m1_t sh1, sl1;
    ...
    fast_2_sum_vv_f16m1(maxs, mins, sh1, sl1, vl);
    
    // exact sum of sh1, rl, (sl1+rll) taking into account their factors
    vfloat16m1_t sh2, sl2, res1, resl1, res2, resl2;
    sl2 = __riscv_vfadd_vv_f16m1(__riscv_vfmul_vf_f16m1(sl1, FACTOR_COEFF_F16, vl), rll, vl);
    fast_2_sum_vv_f16m1(sl, sl2, sh2, sl2, vl);
    // case (1): sh1 -> 0
    fast_2_sum_vv_f16m1(__riscv_vfmul_vf_f16m1(sh1, FACTOR_COEFF_F16, vl), sh2, res1, resl1, vl);
    res1 = __riscv_vfmul_vf_f16m1(__riscv_vfadd_vv_f16m1(
        res1, __riscv_vfadd_vv_f16m1(resl1, sl2, vl), vl), INV_FACTOR_COEFF_F16, vl);
    // case (2): sh1 -> inf
    fast_2_sum_vv_f16m1(sh1, __riscv_vfmul_vf_f16m1(sh2, INV_FACTOR_COEFF_F16, vl), res2, resl2, vl);
    res2 = __riscv_vfadd_vv_f16m1(res2, __riscv_vfadd_vv_f16m1(
        resl2, __riscv_vfmul_vf_f16m1(sl2, INV_FACTOR_COEFF_F16, vl), vl), vl);
    // merge (1) and (2)
    vbool16_t infResMask = __riscv_vmsgeu_vx_u16m1_b16(__riscv_vand_vx_u16m1(
        __riscv_vreinterpret_v_f16m1_u16m1(res1), (uint16_t)0x7c00, vl), (uint16_t)0x7c00, vl);
    res = __riscv_vmerge_vvm_f16m1(res1, res2, infResMask, vl);
}
...
forceinline void calculate_expm1_polynom_hl_f16m2(const vfloat16m2_t& yh, const vfloat16m2_t& yl, vfloat16m2_t& ph, vfloat16m2_t& pl, size_t vl)
{
    // ph + pl = polynom(yh+yl) * FACTOR_COEFF_F16
    vfloat16m2_t pl1;
    vfloat16m2_t sqryh = __riscv_vfmul_vv_f16m2(yh, yh, vl);
    vfloat16m2_t r = calc_polynom_deg_1_f16m2(yh, EXPM1_POL_COEFF_2_F16, EXPM1_POL_COEFF_3_F16, vl);
    r = __riscv_vfmul_vv_f16m2(r, yh, vl);
    mul12_vv_f16m2(yh, r, ph, pl1, vl);
    fast_2_sum_vv_f16m2(__riscv_vfmul_vf_f16m2(yh, FACTOR_COEFF_F16, vl), ph, ph, pl, vl);
    pl = __riscv_vfadd_vv_f16m2(pl, __riscv_vfadd_vv_f16m2(__riscv_vfmul_vf_f16m2(yl, FACTOR_COEFF_F16, vl), pl1, vl), vl);
}

forceinline void calculate_exp2_polynom_hl12_f16m2(const vfloat16m2_t& yh, vfloat16m2_t& ph, vfloat16m2_t& pl, size_t vl)
{
    vfloat16m2_t sqryh = __riscv_vfmul_vv_f16m2(yh, yh, vl);
    vfloat16m2_t r = calc_polynom_deg_1_f16m2(yh, EXP2_POL_COEFF_2_F16, EXP2_POL_COEFF_3_F16, vl);
    r = __riscv_vfmadd_vf_f16m2(yh, EXP2_POL_COEFF_1_L_F16, __riscv_vfmul_vv_f16m2(sqryh, r, vl), vl);
    fma12_ver2p1_vf_f16m2(yh, EXP2_POL_COEFF_1_H_F16, r, ph, pl, vl);
}

forceinline void update_exponent_f16m2(const FLOAT16_T& subnormalThreshold, const vfloat16m2_t& x,
    const vuint16m2_t& ei, vfloat16m2_t& res, size_t vl)
{
    ...
    vuint16m2_t pow2ei = __riscv_vsll_vx_u16m2(__riscv_vand_vx_u16m2(__riscv_vadd_vx_u16m2(ei, (uint16_t)29, vl),  // 29=14+15
        (uint16_t)0x001f, vl), (size_t)10, vl);
    // multiplication calls FE_UNDERFLOW if necessary
    vfloat16m2_t subnormalRes = __riscv_vfmul_vv_f16m2(res, __riscv_vreinterpret_v_u16m2_f16m2(pow2ei), vl);
    subnormalRes = __riscv_vfmul_vf_f16m2(subnormalRes, 0x1p-14f16, vl);
...
forceinline void reconstruct_exp_hl_hl_f16m2(const vfloat16m2_t& x, const vuint16m2_t& ei, const vfloat16m2_t& th, const vfloat16m2_t& tl,
    const vfloat16m2_t& pm1h, const vfloat16m2_t& pm1l, vfloat16m2_t& res, const FLOAT16_T& subnormalThreshold, size_t vl)
{
    vfloat16m2_t sh, sl;
    fast_2_sum_fv_f16m2(ONE_F16, pm1h, sh, sl, vl);
    sl = __riscv_vfadd_vv_f16m2(sl, pm1l, vl);
    mul21_vv_f16m2(th, tl, sh, sl, res, vl);
    update_exponent_f16m2(subnormalThreshold, x, ei, res, vl);
}

forceinline void reconstruct_expm1_f16m2(const vfloat16m2_t& th, const vfloat16m2_t& tl, 
    const vfloat16m2_t& pm1h, const vfloat16m2_t& pm1l, const vuint16m2_t& ei, vfloat16m2_t& res, size_t vl)
{  
    // res = ((FACTOR_COEFF_F16 + pm1h + pm1l)*(th + tl) - FACTOR_COEFF_F16)/FACTOR_COEFF_F16
    vfloat16m2_t rh, rl, rll, sh, sl;
    fast_2_sum_fv_f16m2(FACTOR_COEFF_F16, pm1h, rh, rl, vl);
    fast_2_sum_vv_f16m2(rl, pm1l, rl, rll, vl);
    mul22_vv_f16m2(th, tl, rh, rl, rh, rl, vl);
    
    vuint16m2_t poweri = __riscv_vsll_vx_u16m2(ei, (size_t)10, vl);
    sh = __riscv_vfmul_vf_f16m2(rh, INV_FACTOR_COEFF_F16, vl);
    sh = __riscv_vreinterpret_v_u16m2_f16m2(__riscv_vadd_vv_u16m2(
        __riscv_vreinterpret_v_f16m2_u16m2(sh), poweri, vl));
    vfloat16m2_t power = __riscv_vreinterpret_v_u16m2_f16m2(__riscv_vsll_vx_u16m2(
        __riscv_vadd_vx_u16m2(ei, (uint16_t)15, vl), (size_t)10, vl));
    vbool8_t rlZeroMask = __riscv_vmfeq_vf_f16m2_b8(rl, ZERO_F16, vl);
    sl = __riscv_vreinterpret_v_u16m2_f16m2(__riscv_vadd_vv_u16m2(
        __riscv_vreinterpret_v_f16m2_u16m2(rl), poweri, vl));
    sl = __riscv_vfmerge_vfm_f16m2(sl, ZERO_F16, rlZeroMask, vl);
    vbool8_t infPowerMask = __riscv_vmseq_vx_u16m2_b8(__riscv_vand_vx_u16m2(
        __riscv_vreinterpret_v_f16m2_u16m2(power), (uint16_t)0x7c00, vl), (uint16_t)0x7c00, vl);
    sl = __riscv_vmerge_vvm_f16m2(__riscv_vfmul_vv_f16m2(power, rl, vl), sl, infPowerMask, vl);
    
    vfloat16m2_t sh1, sl1;
    ...
    fast_2_sum_vv_f16m2(maxs, mins, sh1, sl1, vl);
    
    // exact sum of sh1, rl, (sl1+rll) taking into account their factors
    vfloat16m2_t sh2, sl2, res1, resl1, res2, resl2;
    sl2 = __riscv_vfadd_vv_f16m2(__riscv_vfmul_vf_f16m2(sl1, FACTOR_COEFF_F16, vl), rll, vl);
    fast_2_sum_vv_f16m2(sl, sl2, sh2, sl2, vl);
    // case (1): sh1 -> 0
    fast_2_sum_vv_f16m2(__riscv_vfmul_vf_f16m2(sh1, FACTOR_COEFF_F16, vl), sh2, res1, resl1, vl);
    res1 = __riscv_vfmul_vf_f16m2(__riscv_vfadd_vv_f16m2(
        res1, __riscv_vfadd_vv_f16m2(resl1, sl2, vl), vl), INV_FACTOR_COEFF_F16, vl);
    // case (2): sh1 -> inf
    fast_2_sum_vv_f16m2(sh1, __riscv_vfmul_vf_f16m2(sh2, INV_FACTOR_COEFF_F16, vl), res2, resl2, vl);
    res2 = __riscv_vfadd_vv_f16m2(res2, __riscv_vfadd_vv_f16m2(
        resl2, __riscv_vfmul_vf_f16m2(sl2, INV_FACTOR_COEFF_F16, vl), vl), vl);
    // merge (1) and (2)
    vbool8_t infResMask = __riscv_vmsgeu_vx_u16m2_b8(__riscv_vand_vx_u16m2(
        __riscv_vreinterpret_v_f16m2_u16m2(res1), (uint16_t)0x7c00, vl), (uint16_t)0x7c00, vl);
    res = __riscv_vmerge_vvm_f16m2(res1, res2, infResMask, vl);
}
...
#ifndef __FAST_MATH__
    if (__riscv_vcpop_m_b8(underflowMask, vl)) RVVMF_EXP_CALL_FE_UNDERFLOW();  // FE_UNDERFLOW
#endif
}
...
forceinline void calculate_expm1_polynom_hl_f16m4(const vfloat16m4_t& yh, const vfloat16m4_t& yl, vfloat16m4_t& ph, vfloat16m4_t& pl, size_t vl)
{
    // ph + pl = polynom(yh+yl) * FACTOR_COEFF_F16
    vfloat16m4_t pl1;
    vfloat16m4_t sqryh = __riscv_vfmul_vv_f16m4(yh, yh, vl);
    vfloat16m4_t r = calc_polynom_deg_1_f16m4(yh, EXPM1_POL_COEFF_2_F16, EXPM1_POL_COEFF_3_F16, vl);
    r = __riscv_vfmul_vv_f16m4(r, yh, vl);
    mul12_vv_f16m4(yh, r, ph, pl1, vl);
    fast_2_sum_vv_f16m4(__riscv_vfmul_vf_f16m4(yh, FACTOR_COEFF_F16, vl), ph, ph, pl, vl);
    pl = __riscv_vfadd_vv_f16m4(pl, __riscv_vfadd_vv_f16m4(__riscv_vfmul_vf_f16m4(yl, FACTOR_COEFF_F16, vl), pl1, vl), vl);
}

forceinline void calculate_exp2_polynom_hl12_f16m4(const vfloat16m4_t& yh, vfloat16m4_t& ph, vfloat16m4_t& pl, size_t vl)
{
    vfloat16m4_t sqryh = __riscv_vfmul_vv_f16m4(yh, yh, vl);
    vfloat16m4_t r = calc_polynom_deg_1_f16m4(yh, EXP2_POL_COEFF_2_F16, EXP2_POL_COEFF_3_F16, vl);
    r = __riscv_vfmadd_vf_f16m4(yh, EXP2_POL_COEFF_1_L_F16, __riscv_vfmul_vv_f16m4(sqryh, r, vl), vl);
    fma12_ver2p1_vf_f16m4(yh, EXP2_POL_COEFF_1_H_F16, r, ph, pl, vl);
}

forceinline void update_exponent_f16m4(const FLOAT16_T& subnormalThreshold, const vfloat16m4_t& x,
    const vuint16m4_t& ei, vfloat16m4_t& res, size_t vl)
{
    ...
    vuint16m4_t pow2ei = __riscv_vsll_vx_u16m4(__riscv_vand_vx_u16m4(__riscv_vadd_vx_u16m4(ei, (uint16_t)29, vl),  // 29=14+15
        (uint16_t)0x001f, vl), (size_t)10, vl);
    // multiplication calls FE_UNDERFLOW if necessary
    vfloat16m4_t subnormalRes = __riscv_vfmul_vv_f16m4(res, __riscv_vreinterpret_v_u16m4_f16m4(pow2ei), vl);
    subnormalRes = __riscv_vfmul_vf_f16m4(subnormalRes, 0x1p-14f16, vl);
...
forceinline void reconstruct_exp_hl_hl_f16m4(const vfloat16m4_t& x, const vuint16m4_t& ei, const vfloat16m4_t& th, const vfloat16m4_t& tl,
    const vfloat16m4_t& pm1h, const vfloat16m4_t& pm1l, vfloat16m4_t& res, const FLOAT16_T& subnormalThreshold, size_t vl)
{
    vfloat16m4_t sh, sl;
    fast_2_sum_fv_f16m4(ONE_F16, pm1h, sh, sl, vl);
    sl = __riscv_vfadd_vv_f16m4(sl, pm1l, vl);
    mul21_vv_f16m4(th, tl, sh, sl, res, vl);
    update_exponent_f16m4(subnormalThreshold, x, ei, res, vl);
}

forceinline void reconstruct_expm1_f16m4(const vfloat16m4_t& th, const vfloat16m4_t& tl, 
    const vfloat16m4_t& pm1h, const vfloat16m4_t& pm1l, const vuint16m4_t& ei, vfloat16m4_t& res, size_t vl)
{  
    // res = ((FACTOR_COEFF_F16 + pm1h + pm1l)*(th + tl) - FACTOR_COEFF_F16)/FACTOR_COEFF_F16
    vfloat16m4_t rh, rl, rll, sh, sl;
    fast_2_sum_fv_f16m4(FACTOR_COEFF_F16, pm1h, rh, rl, vl);
    fast_2_sum_vv_f16m4(rl, pm1l, rl, rll, vl);
    mul22_vv_f16m4(th, tl, rh, rl, rh, rl, vl);
    
    vuint16m4_t poweri = __riscv_vsll_vx_u16m4(ei, (size_t)10, vl);
    sh = __riscv_vfmul_vf_f16m4(rh, INV_FACTOR_COEFF_F16, vl);
    sh = __riscv_vreinterpret_v_u16m4_f16m4(__riscv_vadd_vv_u16m4(
        __riscv_vreinterpret_v_f16m4_u16m4(sh), poweri, vl));
    vfloat16m4_t power = __riscv_vreinterpret_v_u16m4_f16m4(__riscv_vsll_vx_u16m4(
        __riscv_vadd_vx_u16m4(ei, (uint16_t)15, vl), (size_t)10, vl));
    vbool4_t rlZeroMask = __riscv_vmfeq_vf_f16m4_b4(rl, ZERO_F16, vl);
    sl = __riscv_vreinterpret_v_u16m4_f16m4(__riscv_vadd_vv_u16m4(
        __riscv_vreinterpret_v_f16m4_u16m4(rl), poweri, vl));
    sl = __riscv_vfmerge_vfm_f16m4(sl, ZERO_F16, rlZeroMask, vl);
    vbool4_t infPowerMask = __riscv_vmseq_vx_u16m4_b4(__riscv_vand_vx_u16m4(
        __riscv_vreinterpret_v_f16m4_u16m4(power), (uint16_t)0x7c00, vl), (uint16_t)0x7c00, vl);
    sl = __riscv_vmerge_vvm_f16m4(__riscv_vfmul_vv_f16m4(power, rl, vl), sl, infPowerMask, vl);
    
    vfloat16m4_t sh1, sl1;
    ...
    fast_2_sum_vv_f16m4(maxs, mins, sh1, sl1, vl);
    
    // exact sum of sh1, rl, (sl1+rll) taking into account their factors
    vfloat16m4_t sh2, sl2, res1, resl1, res2, resl2;
    sl2 = __riscv_vfadd_vv_f16m4(__riscv_vfmul_vf_f16m4(sl1, FACTOR_COEFF_F16, vl), rll, vl);
    fast_2_sum_vv_f16m4(sl, sl2, sh2, sl2, vl);
    // case (1): sh1 -> 0
    fast_2_sum_vv_f16m4(__riscv_vfmul_vf_f16m4(sh1, FACTOR_COEFF_F16, vl), sh2, res1, resl1, vl);
    res1 = __riscv_vfmul_vf_f16m4(__riscv_vfadd_vv_f16m4(
        res1, __riscv_vfadd_vv_f16m4(resl1, sl2, vl), vl), INV_FACTOR_COEFF_F16, vl);
    // case (2): sh1 -> inf
    fast_2_sum_vv_f16m4(sh1, __riscv_vfmul_vf_f16m4(sh2, INV_FACTOR_COEFF_F16, vl), res2, resl2, vl);
    res2 = __riscv_vfadd_vv_f16m4(res2, __riscv_vfadd_vv_f16m4(
        resl2, __riscv_vfmul_vf_f16m4(sl2, INV_FACTOR_COEFF_F16, vl), vl), vl);
    // merge (1) and (2)
    vbool4_t infResMask = __riscv_vmsgeu_vx_u16m4_b4(__riscv_vand_vx_u16m4(
        __riscv_vreinterpret_v_f16m4_u16m4(res1), (uint16_t)0x7c00, vl), (uint16_t)0x7c00, vl);
    res = __riscv_vmerge_vvm_f16m4(res1, res2, infResMask, vl);
}
...
#ifndef __FAST_MATH__
    if (__riscv_vcpop_m_b4(underflowMask, vl)) RVVMF_EXP_CALL_FE_UNDERFLOW();  // FE_UNDERFLOW
#endif
}
